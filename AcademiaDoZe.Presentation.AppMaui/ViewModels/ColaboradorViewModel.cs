    ...
    public partial class ColaboradorViewModel : BaseViewModel
    {
        ...
        public async Task InitializeAsync()
        {
            ...
            else
            {
                ...
                // Garantir que estamos com um objeto novo
        ...
        public async Task SaveColaboradorAsync()
        {
            ...
            try
            {
                ...
                // Atribui o logradouro encontrado
                ...
                {
                    // Para novo colaborador, garantir que o ID está zerado
                    Colaborador.Id = 0;
        ...
        private static bool ValidateColaborador(ColaboradorDTO colaborador)
        {
            ...
            // Validar se a data de nascimento é válida e a pessoa tem pelo menos 16 anos
            if (colaborador.DataNascimento == default ||
                colaborador.DataNascimento > DateOnly.FromDateTime(DateTime.Today.AddYears(-16)))
            {
                Shell.Current.DisplayAlert(validationTitle, "Data de nascimento é obrigatória e a pessoa deve ter pelo menos 16 anos.", "OK");
                return false;
            }

            if (string.IsNullOrWhiteSpace(colaborador.Telefone) || colaborador.Telefone.Length < 10)
            {
                Shell.Current.DisplayAlert(validationTitle, "Telefone deve ter pelo menos 10 dígitos.", "OK");
                return false;
            }
            ...
            if (colaborador.DataAdmissao == default || colaborador.DataAdmissao > DateOnly.FromDateTime(DateTime.Today))
            {
                Shell.Current.DisplayAlert(validationTitle, "Data de admissão é obrigatória e não pode ser futura.", "OK");
                return false;
            }
