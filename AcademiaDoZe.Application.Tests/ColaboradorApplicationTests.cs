...
namespace AcademiaDoZe.Application.Tests
{
    public class ColaboradorApplicationTests
    {
        ...
        const string connectionString = "Server=localhost;Database=db_academia_do_ze;User Id=sa;Password=$Tmlts&29;TrustServerCertificate=True;Encrypt=True";
        ...
        public async Task ColaboradorService_Integracao_Adicionar_Obter_Atualizar_Remover()
        {
            ...
            var dto = new ColaboradorDTO
            {
                ...
                Email = "email29errounico@teste.com",
                Endereco = logradouro,
                Numero = "100",
                Complemento = "Apto 1",
                Senha = "Senha@1",
                ...
                Tipo = EAppColaboradorTipo.Atendente,
